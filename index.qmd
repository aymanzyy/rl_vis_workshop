...
1. [Background](#background)
    - [What's Out There](#wecare)
2. [Types of Visualization](#documentation)
    - [Post Hoc](#wiki)
    - [In Situ](#box)
    - [Python-based](#outlook)
3. [ParaView Overview](#overview)
4. [ParaView Usage](#usage)
...
## Types of Visualization { .centeredslide}
:::: {.columns}
...
:::
::::
# ParaView (Kitware) {#paraview .centeredslide}
:::: {.columns}
...
# ParaView Usage {#usage .centeredslide}
:::: {.columns}
...
:::: {.columns}
::: {.column width="49%"}
![](https://gyazo.com/e088acc56246b525fba02c8cbf17451c)
:::
...
![](assets/test_longer_mbt_ani.avi)
:::
...
## How Do We Use Filters? {.centeredslide}
::::{.columns}
...
# ParaView Animations {.centeredslide}
...
::: {.column width="50%"}
![](https://gyazo.com/e67ef5964cf8d76ce6fe797e59149579)
:::
